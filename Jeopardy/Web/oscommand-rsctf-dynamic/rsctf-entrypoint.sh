...
marker=RSCTF_DYNAMIC_FLAG_c1665742f510a54dc55680ebe9afc307c6590bea50f6897a7e0f
payload_marker=RSCTF_DYNAMIC_FLAG_fc6d47687ed2cb600be114713b6f72c7e00b962d1bb5a
rsctf_payload=${RSCTF_FLAG#*\{}
rsctf_payload=${rsctf_payload%\}}
if [ -f /etc/rsctf-flag-targets ]; then
  while IFS= read -r target; do
    [ -f "$target" ] || continue
    sed -i -e "s|${marker}|${RSCTF_FLAG}|g" -e "s|${payload_marker}|${rsctf_payload}|g" "$target"
